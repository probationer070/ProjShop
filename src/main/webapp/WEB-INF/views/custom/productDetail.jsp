   		...
   		<table class="tableinfo">
   			<tr>
   				...
   				<td class="cols">
   					...
   					<table>
						<tr>
							<th class="pcol1-1 ">브랜드</th>
							<th class="pcol2-1">
								<input class="form-control-plaintext num" type="text"
								name="p_name" class="chk" title="브랜드" value="${product.p_name}" readonly="readonly"> 
								<input class="form-control-plaintext num" type="hidden"
								name="p_no" title="브랜드" value="${product.p_no}" readonly="readonly"> 
							</th>
						...
						<tr>
							...
							<th class="pcol2-1">
								<input class="form-control-plaintext num" type="text"
								name="price" class="chk number" title="상품가격" value="${product.price}" readonly="readonly"> 
							</th>
			  			</tr>
						<tr>
							<th class="pcol1-1">구매수량</th>
							<th class="pcol2-1">
								<input class="form-control" type="text" name="quantity" class="chk inNum"
								       title="구매수량" value="1"> 
							</th>
			  			</tr>
				   	</table>
