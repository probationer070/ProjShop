	...
	<form action="" name="form1" method="post">
   	...
   	<div class="btnArea" align="center">
   		...
   		<c:if test='${ssKey.m_role=="admin"}'>
   			<button type="button" name="list" class="btn-second btn-primary" onclick="location.href='/admin/noticeFIX'">공지사항목록</button>
   			<button type="button" name="update" class="btn-primary notisubmit" value="수정">수정</button>
   			<button type="button" name="delete" class="btn-primary notisubmit" value="삭제">삭제</button>
   		</c:if>
   	</div>
	</form>
</div>
